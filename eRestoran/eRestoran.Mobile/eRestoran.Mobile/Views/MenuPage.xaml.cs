...
namespace eRestoran.Mobile.Views
{
    ...
    public partial class MenuPage : ContentPage
    {
        ...
        public MenuPage()
        {
            ...
            {
                new HomeMenuItem {Id = MenuItemType.Browse, Title="eRestoran" },
                new HomeMenuItem {Id = MenuItemType.EditProfil, Title="Moj profil" },
                 new HomeMenuItem {Id = MenuItemType.Proizvodi, Title="Proizvodi" },
                  new HomeMenuItem {Id = MenuItemType.Narudzba, Title="Narudzba" },
                   ...
                   new HomeMenuItem {Id = MenuItemType.SveNarudzbe, Title="Sve Narudzbe" }
            };
